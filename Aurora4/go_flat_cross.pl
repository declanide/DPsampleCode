...
# tune_muti default rough not precise
...
pause($rechmm." ".$bestP." ".$bestS);

system $AUEXE."/eval92_muti.pl ".$rechmm." ".$novaddstr2." ".$PRUNE2." ".$bestP." ".$bestS." cross ".$TESTSCP." cnvp";
