...
#system "train_iter.pl $HMM_ROOT hmm13 hmm14 $TIEDLIST $TRIWORDS 0 bin $TRAINSCP";
...
#system "train_iter.pl $HMM_ROOT hmm14 hmm15 $TIEDLIST $TRIWORDS 0 bin $TRAINSCP";
...
#system "train_iter.pl $HMM_ROOT hmm15 hmm16 $TIEDLIST $TRIWORDS 0 bin $TRAINSCP";
...
#system "train_iter.pl $HMM_ROOT hmm16 hmm17 $TIEDLIST $TRIWORDS 0 bin $TRAINSCP";
